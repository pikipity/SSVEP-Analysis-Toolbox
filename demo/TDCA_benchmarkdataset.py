...
data = {"acc_store": acc_store,
        ...
        "test_time": test_time}
data_file = 'res/tdca_benchmarkdataset_res.mat'
...
fig, _ = bar_plot(train_time,
                  ...
                  grid = True)
fig.savefig('res/tdca_benchmarkdataset_traintime_bar.jpg', bbox_inches='tight', dpi=300)
...
fig, _ = bar_plot(test_time,
                  ...
                  x_ticks = [model.ID for model in model_container],
                  grid = True)
fig.savefig('res/tdca_benchmarkdataset_testtime_bar.jpg', bbox_inches='tight', dpi=300)
...
fig, _ = bar_plot_with_errorbar(acc_store,
                                ...
                                grid = True,
                                ylim = [0, 1])
fig.savefig('res/tdca_benchmarkdataset_acc_bar.jpg', bbox_inches='tight', dpi=300)
...
fig, _ = bar_plot_with_errorbar(itr_store,
                                ...
                                grid = True,
                                ylim = [0, 190])
fig.savefig('res/tdca_benchmarkdataset_itr_bar.jpg', bbox_inches='tight', dpi=300)
...
fig, _ = shadowline_plot(tw_seq,
                        ...
                        grid = True,
                        ylim = [0, 1])
fig.savefig('res/tdca_benchmarkdataset_acc_shadowline.jpg', bbox_inches='tight', dpi=300)
...
fig, _ = shadowline_plot(tw_seq,
                        ...
                        grid = True,
                        ylim = [0, 190])
fig.savefig('res/tdca_benchmarkdataset_itr_shadowline.jpg', bbox_inches='tight', dpi=300)
