...
fig, _ = bar_plot_with_errorbar(acc_store,
                                ...
                                grid = True,
                                ylim = [0, 1])
fig.savefig('res/cca_betadataset_acc_bar.png')
...
fig, _ = bar_plot_with_errorbar(itr_store,
                                ...
                                grid = True,
                                ylim = [0, 190])
fig.savefig('res/cca_betadataset_itr_bar.png')
...
fig, _ = shadowline_plot(tw_seq,
                        ...
                        grid = True,
                        ylim = [0, 1])
fig.savefig('res/cca_betadataset_acc_shadowline.png')
...
fig, _ = shadowline_plot(tw_seq,
                        ...
                        grid = True,
                        ylim = [0, 190])
fig.savefig('res/cca_betadataset_itr_shadowline.png')
